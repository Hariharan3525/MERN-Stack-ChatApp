                ...
                <div className="bg-base-100 rounded-xl shadow-md overflow-hidden">
                  ...
                  <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-medium text-sm">Hariharan M</h3>
                  ...
                  <div className="p-4 space-y-4 min-h-[200px] overflow-y-auto bg-base-100">
                    {PREVIEW_MESSAGES.map((message) => (
                      <div key={message.id} className={`flex ${message.isSent ? "justify-end" : "justify-start"}`}>
                        <div className={`max-w-[80%] rounded-xl p-3 shadow-md ${message.isSent ? "bg-primary text-primary-content" : "bg-base-200"}`}>
